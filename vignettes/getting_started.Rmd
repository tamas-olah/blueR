...
<html>
  ...
  <title>BlueR Static Template</title>
  ...
  <link type="text/css" href="inst/assets/css/blue.min.css" rel="stylesheet"/>
  <body>
    ...
    <script src="inst/assets/js/blue.min.js"></script>
  </body>
</html>
```
</details>
...
Surprisingly, we need the `blueNavbar()` function, see below:
  ...
  blueNavMenu(
    blueDropdown(
      ...
      blueDropdownItem(
        ...
        description = "Blabla",
        src = "",
        icon = blueIcon("spaceship", color = "white"),
        status = "primary"
      ),
      blueDropdownItem(
        name = "Foundation",
        description = "Blabla",
        src = "",
        icon = blueIcon("palette", color = "white"),
        status = "warning"
      ),
      blueDropdownItem(
        name = "Components",
        description = "Blabla",
        src = "",
        icon = blueIcon("ui-04", color = "white),
        status = "success"
      )
    )
  ),
...
The `blueNavbar()` function accepts `blueNavMenu()`, which in turns takes
`blueNavItem()` and `blueDropdown()`.


#### Insert the footer

We need the `blueFooter()` function:
...
In general, footer elements are wrapped in several `blueSection()`. 

#### Fill the body

All body elements must be wrapped in a `blueSection()`, for instance:
...
the `bluePageTemplate()` function provides additional treatments 
    ...
    blueNavMenu(
      blueDropdown(
        ...
        blueDropdownItem(
          ...
          src = "test.html",
          icon = blueIcon(name = "spaceship" color = "primary")
        ),
        blueDropdownItem(
          name = "Foundation",
          description = "BlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBla",
          src = "",
          icon = blueIcon(name = "palette" color = "warning")
        ),
        blueDropdownItem(
          name = "Components",
          description = "BlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBlaBla",
          src = "",
          icon = blueIcon(name = "ui-04" color = "success")
        )
      )
    ),
    # right menu
...
bluePageTemplate(filename = "example", path = getwd(), example)
```
</details>
<br>