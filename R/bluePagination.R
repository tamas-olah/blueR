#' Build an blue pagination container
#'
#' @param ... Slot for \link{bluePaginationItem}.
...
#' }
#' 
#' @note align will not work if you embed the bluePagination in an blueRow.
#'
#' @author David Granjon, \email{dgranjon@@ymail.com}
#'
#' @export
bluePagination <- function(..., size = NULL, align = NULL) {
...
#'
#' @export
bluePaginationItem <- function(name, src = NULL) {
