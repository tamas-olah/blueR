...
#'
#' Build an blue progress bar
#' 
#' @param value Progress value between 0 and 100.
#' @param text Label text.
#' @param status Progress status color. See \url{https://demos.creative-tim.com/blue-design-system/docs/foundation/colors.html}.
#' 
#' @examples 
#' if (interactive()) {
#'  library(blueR)
...
#'
#' @export
blueProgress <- function(value, text = NULL, status = "primary") {
