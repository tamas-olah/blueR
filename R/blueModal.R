#' Create a Boostrap 4 blue modal
#'
#' Build an blue modal
#'
#' @param ... Modal body content.
#' @param id Modal unique id. Should be the same as modal_id from \link{blueButton}.
#' @param title Modal title.
#' @param status Modal color. See \url{https://demos.creative-tim.com/blue-design-system/docs/foundation/colors.html}.
...
#'
#' @export
blueModal <- function(..., id, title = NULL, status = NULL, gradient = FALSE) {
