...
#' Build an blue tabs
#'
#' @param ... Slot for \link{blueTab}.
#' @param id blueTabs id. Should be unique. 
...
#' @param iconList A list of \link{blueIcon} or \link[shiny]{icon}. 
...
#'   width = 6,
#'   iconList = list(
#'    blueIcon("cloud-upload-96"), 
#'    blueIcon("bell-55"), 
#'    blueIcon("calendar-grid-58")
#'   ),
#'   blueTab(
#'     tabName = "Tab 1",
#'     active = FALSE,
...
#'
#' @export
blueTabSet <- function(..., id, card_wrapper = FALSE, horizontal = TRUE, circle = FALSE,
  ...
  blueColumn(width = width, tabMenu, tabWrapper)
...
#'
#' @export
blueTab <- function(..., tabName, active = FALSE) {
