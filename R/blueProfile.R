...
#' @param stats Stats items. See \link{blueProfileStats}.
#' 
#' @note Do not work on blueR. Only for blue Dash
#' 
#' @examples
#' if(interactive()){
#'  library(blueR)
...
#'
#' @export
blueProfile <- function(..., title = NULL, subtitle = NULL, src = NULL, url = NULL,
...
#'
#' Build an blue profile card stats container
#'
#' @param ... Slot for \link{blueProfileStat}.
#' 
#' @author David Granjon, \email{dgranjon@@ymail.com}
#'
#' @export
blueProfileStats <- function(...) {
  htmltools::tags$div(
...
#'
#' Build an blue profile card stat item
#'
...
#'
#' @export
blueProfileStat <- function(value, description) {
  htmltools::tags$div(
