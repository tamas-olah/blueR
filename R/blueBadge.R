...
#' @param status Badge status. See \url{https://demos.creative-tim.com/blue-design-system/docs/components/badge.html}.
#' 
#' @examples 
#' if (interactive()) {
#'  library(blueR)
...
#'
#' @export
blueBadge <- function(text = NULL, src = NULL, pill = FALSE, status = "default") {
