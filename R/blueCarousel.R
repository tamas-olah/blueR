#' Create a carousel
#'
#' Build an blue carousel
#' 
#' @param ... Slot for \link{blueCarouselItem}.
...
#'
#' @export
blueCarousel <- function(..., id, floating = FALSE, hover_lift = FALSE, width = 6) {
  ...
  # column wrapper
  blueContainer(blueColumn(width = width, carouselTag))
}
...
#'
#' @export
blueCarouselItem <- function(src = NULL, active = FALSE, mode = "img") {
  htmltools::tags$div(
    class = if (active) {
