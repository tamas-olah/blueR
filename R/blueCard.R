...
#' @param icon Card icon. Expect \link{blueIcon} or \link[shiny]{icon}.
#' @param btn_text Button text. src arg must not be NULL so that this button appears.
#' @param status Card status. See \url{https://demos.creative-tim.com/blue-design-system/docs/foundation/colors.html}.
#' @param background_color Card background color. NULL by default. See \url{https://demos.creative-tim.com/blue-design-system/docs/foundation/colors.html}.
...
#'
#' @export
blueCard <- function(..., title = NULL, src = NULL, hover_lift = FALSE, 
  ...
  blueColumn(width = width, cardTag)
